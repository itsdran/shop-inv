				            ...
				            <div class="row">
				                <div class="col-md-12">
				                    <div class="mt-2 mb-3 clearfix" >
				                    	<table style="width: 94%;  margin: auto;">
											<tr>
												<td valign="bottom">
													<h2 class="pull-left">Customer Details</h2>
												</td>
												<td valign="bottom">
				                        			<a style="background-color: #ECAC3D; border-color: #ECAC3D;" href="create_customer.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Customer</a>
				                    			</td>
											</tr>
										</table>
				                    </div><br>
				                        ...
				                        if(mysqli_num_rows($result) > 0){
				                            echo '<table id="dtDynamicVerticalScrollExample" class="table table-hover table-sm table-striped">';
				                                ...
				                                while($row = mysqli_fetch_array($result)){
				                                    echo "<tr>";
				                                   		echo "<td style='color:black;'>" . $row['customerID'] . "</td>";
				                                        echo "<td style='color:black;'>" . $row['fullName'] . "</td>";
				                                        ...
				                                        echo "<td style='color:black; text-align: center;'>";
				                                            echo '<a href="update_customer.php?customerID='. $row['customerID'] .'" class="mr-4" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
				                                            echo '<a href="delete_customers.php?customerID='. $row['customerID'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
				                                        echo "</td>";
				                                    echo "</tr>";
				                                }
				                                echo "</tbody>";                            

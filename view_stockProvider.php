...
<?php include "header_web.html"?>
	<div class="row">
		<div class="column1">
			...
			<div class="column2">
				<div class="wrapper">
					<div class="container-fluid" style=" border-radius: 35px; background-color: white; margin-top: 40px; padding-bottom: 40px; "></style>
						<div class="row">
							<div class="col-md-12">
								<div class="mt-2 mb-3 clearfix" >
									<table style="width: 100%;  margin: auto;"><tr><td valign="bottom">
									<h2 class="pull-left">Stock Provider Details</h2>
									</td>
									<td valign="bottom">
									<a style="background-color: #ECAC3D; border-color: #ECAC3D;" href="create_stockprovider.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Stock Provider</a></style>
									</td></tr></table>
								</div><br>
								<?php
								// Include config file
									...
									if(mysqli_num_rows($result) > 0){
										echo '<table id="dtDynamicVerticalScrollExample" class="table table-hover table-sm table-striped">';
											...
											while($row = mysqli_fetch_array($result)){
												echo "<tr>";
													echo "<td style='color:black;'>" . $row['sProviderID'] . "</td>";
													echo "<td style='color:black;'>" . $row['companyName'] . "</td>";
													echo "<td style='color:black;'>" . $row['vendorName'] . "</td>";
													echo "<td style='color:black;'>" . $row['mobile'] . "</td>";
													echo "<td style='color:black;'>" . $row['email'] . "</td>";
													echo "<td style='color:black;'>" . $row['status'] . "</td>";
													echo "<td style='color:black;'>" . $row['address'] . "</td>";
													echo "<td style='color:black; text-align: center;'>";
													echo '<a href="update_stockprovider.php?sProviderID='. $row['sProviderID'] .'" class="mr-4" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
													echo '<a href="delete_stockprovider.php?sProviderID='. $row['sProviderID'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
												echo "</td>";
												echo "</tr>";
											}
											echo "</tbody>";                            

							...
							<div class="mt-2 mb-3 clearfix">
								<table style="width: 100%;  margin: auto; color: black">
									<tr>
										...
										<td valign="bottom">
											<a style="background-color: #ECAC3D; border-color: #ECAC3D;" href="create_item.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New Product</a>
										</td>
									</tr>
								</table>
							</div><br>
							...
							if ($result = mysqli_query($link, $sql)) {
								if (mysqli_num_rows($result) > 0) {
									...
									while ($row = mysqli_fetch_array($result)) {
										echo "<tr>";
										echo "<td style='color:black;'>" . $row['productID'] . "</td>";
										...
										echo "<td style='color:black;'>" . $row['stock'] . "</td>";
										...
										echo '<a href="read.php?productID=' . $row['productID'] . '" class="mr-4" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
										echo '<a href="update_item.php?productID=' . $row['productID'] . '" class="mr-4" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
										echo '<a href="delete_item.php?productID=' . $row['productID'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
										echo "</td>";
										echo "</tr>";
									}
									echo "</tbody>";

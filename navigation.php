    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="index.php"><img src="pic/ocs.jpg" width="33px" height="33px"><font color="#F0B56F">   O</font>nline <font color="#F0B56F">C</font>lothing <font color="#F0B56F">S</font>tore</a>

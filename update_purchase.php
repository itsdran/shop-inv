...
require_once('header.html');
	...
	if (isset ($_POST['purchaseID'])) {
		...
		$query = "	UPDATE purchase 
					SET 	itemNumber='$itemNumber', purchaseDate='$purchaseDate', itemName='$itemName', 
							unitPrice='$unitPrice', quantity='$quantity', vendorName='$vendorName', 
							vendorID='$vendorID' WHERE purchaseID='$id'";
					...
					<div class="tab-pane fade show active" id="v-pills-item" role="tabpanel"
						...
						<div class="card-body">
							<ul class="nav nav-tabs" role="tablist">
								<li class="nav-item">
									<a class="nav-link active" data-toggle="tab" href="#itemDetailsTab">Purchase</a>
								</li>
							</ul>
										...
										<div class="form-row">
											...
											<div class="form-group col-md-3">
												...
												<input type="date" required name="purchaseDate"
													class="form-control <?php echo (!empty($purchaseDate_err)) ? 'is-invalid' : ''; ?>"
													autocomplete="off" value="<?php echo $purchaseDate; ?>">
													<span class="invalid-feedback"><?php echo $purchaseDate_err;?>
                                            </div>
										</div>
										
=======
										<br><br><br>
										<button type="button" id="updatePurchaseDetailsButton" style="background-color: #ECAC3D; border-color: #ECAC3D;"class="btn btn-success">Update</button>

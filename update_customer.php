...
if(isset($_POST["customerID"]) && !empty($_POST["customerID"])){
    ...
    if(empty($name_err) && empty($address_err)  && empty($email_err)){
        ...
        $sql = "UPDATE customer SET fullName=?, mobile=?, email=?, status=?, address=? WHERE customerID=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssssi", $param_name, $param_mobile, $param_email, $param_status, $param_address, $param_id);
	...
	<div class="row">
		<div class="column1">
			<ul id="ulsidebar"><b>
					...
					<li class="sideLi"><a class="active" href="view_stockProvider.php">STOCK PROVIDERS</a></li>
					<li class="sideLi"><a href="view_sales.php">SALES</a></li>
					<li class="sideLi"><a href="view_customers.php">CUSTOMER</a></li>
...
=======
							<br><br><br>
							<input type="submit" style="background-color: #ECAC3D; border-color: #ECAC3D;"class="btn btn-success" value="Update Customer">
>>>>>>> Stashed changes
